...
echo '</div>';
            ...
            echo '<div class="form-group">';
            echo '<label for="unidade_' . $row_aluno["aluno_id_3a"] . '">Unidade:</label>';
            echo '<select id="unidade_' . $row_aluno["aluno_id_3a"] . '" name="unidade[]" required>';
            ...
            echo '<div class="form-group">';
            echo '<label for="nota1_' . $row_aluno["aluno_id_3a"] . '">Nota AV1:</label>';
            echo '<input type="text" id="nota1_' . $row_aluno["aluno_id_3a"] . '" name="nota1[]" placeholder="Digite a nota da AV1" required>';
            echo '</div>';
            echo '<div class="form-group">';
            echo '<label for="nota2_' . $row_aluno["aluno_id_3a"] . '">Nota AV2:</label>';
            echo '<input type="text" id="nota2_' . $row_aluno["aluno_id_3a"] . '" name="nota2[]" placeholder="Digite a nota da AV2" required>';
            echo '</div>';
            ...
            echo '<div class="form-group">';
            echo '<label for="conceito_' . $row_aluno["aluno_id_3a"] . '">Conceito:</label>';
            echo '<select id="conceito_' . $row_aluno["aluno_id_3a"] . '" name="conceito[]" required>';
            echo '<option value="A">D</option>';
            echo '<option value="B">NA</option>';
            echo '</select>';
            echo '</div>';
